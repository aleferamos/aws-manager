...
16	AWS_CLOUDFRONT_LIST_DISTRIBUTIONS	Aws cloudfront list distributions	Permite listar distribuicoes CloudFront da conta AWS vinculada a credencial.	CREDENTIAL	2026-05-25 13:30:00
17	AWS_CLOUDFRONT_LIST_INVALIDATIONS	Aws cloudfront list invalidations	Permite listar invalidations de distribuicoes CloudFront da conta AWS vinculada a credencial.	CREDENTIAL	2026-05-25 13:30:00
18	AWS_CLOUDFRONT_CREATE_INVALIDATION	Aws cloudfront create invalidation	Permite criar invalidations em distribuicoes CloudFront da conta AWS vinculada a credencial.	CREDENTIAL	2026-05-25 13:30:00
\.
...
SELECT pg_catalog.setval('public.authority_id_seq', 18, true);
